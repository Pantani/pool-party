...
// NewSeedWithErrorChecking creates a hashed bip39 output given the mnemonic string and a password.
...
// NewSeed creates a hashed bip39 output given a provided string and password.
